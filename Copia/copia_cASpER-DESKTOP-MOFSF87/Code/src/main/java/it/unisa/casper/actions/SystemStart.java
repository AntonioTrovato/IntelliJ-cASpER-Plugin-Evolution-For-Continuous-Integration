...
import it.unisa.casper.parser.ClassParser;
import it.unisa.casper.parser.PackageParser;
...
public class SystemStart {
    ...
    public void form(Project currentProject) {
        ...
        CheckProjectPage frame = new CheckProjectPage(currentProject, null, minC, sogliaStructural, algoritmo);
        frame.show();
